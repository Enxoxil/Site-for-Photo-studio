    ...
    render() {
        return (
            ...
            <article className="article">
                <div className="article__wrapper article__wrapper_background-blue">
                    <div className="article__container _container">
                        <h2 className="article__title _h2-title">
                        ...
                        <p className="article__content">
                            ...
                            испытывать прилив нежности, значит семейная фотоссесия в нашей
